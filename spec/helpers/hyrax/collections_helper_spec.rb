...
RSpec.describe Hyrax::CollectionsHelper, skip: true do
  ...
  describe '#render_collection_links' do
    ...
    context 'when a DataSet does not belongs to any collections', :clean_repo do
      let!(:work_doc) { SolrDocument.new(id: '123', title_tesim: ['My DataSet']) }
    ...
    context 'when a DataSet belongs to collections' do
