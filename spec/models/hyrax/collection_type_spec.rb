...
RSpec.describe Hyrax::CollectionType, type: :model do
  ...
  describe '#gid', skip: Rails.configuration.hyrax5_spec_skip do
  ...
  context 'instance methods' do
    ...
    describe "#collections" do
      it 'returns empty array if gid is nil' do
        ...
        expect(Hyrax.query_service.count_all_of_model(model: CollectionResource)).not_to be_zero unless Rails.configuration.hyrax5_spec_skip
