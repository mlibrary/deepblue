...
RSpec.describe Hyrax::FileSetsController, :clean_repo do
  ...
  describe 'module debug verbose variables' do
    it "they have the right values" do
      ...
      expect( ::Hyrax::AnonymousLinkService.anonymous_link_service_debug_verbose ).to eq( false )
    end
  end
  ...
  context 'anonymous_link' do

    before do
      expect(::Deepblue::LoggingHelper).to_not receive(:bold_debug)
      # allow(::Hyrax::AnonymousLinkService).to receive(:anonymous_link_destroy_if_published).and_call_original
      # allow(::Hyrax::AnonymousLinkService).to receive(:anonymous_link_destroy_if_tombstoned).and_call_original
    end
  ...
  context '#assign_to_work_as_read_me', skip: false do
  ...
  context '#create_anonymous_link', skip: false do
  ...
  context '#create_single_use_link', skip: false do
  ...
  context '#display_provenance_log', skip: false do
