...
## NOTE: DBD doesn't support Arkivo at this point

RSpec.describe Hyrax::API::ZoteroController, type: :controller, skip: false do

  it "has tests when we integrate with Zotero" do
