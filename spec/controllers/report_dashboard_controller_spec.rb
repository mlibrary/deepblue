...
RSpec.describe ReportDashboardController do
  ...
  describe 'module debug verbose variables' do
    it { expect( described_class.report_dashboard_controller_debug_verbose ).to eq debug_verbose }
  end

  describe 'class variables' do
    it { expect( described_class.presenter_class ).to eq ReportDashboardPresenter }
  end
