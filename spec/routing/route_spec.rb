...
RSpec.describe 'Routes', type: :routing do
  ...
  describe 'main app routes' do
    ...
    describe 'DataSet' do
      it "routes to show" do
        expect(get: '/concern/data_sets/4').to route_to(controller: 'hyrax/data_sets', action: 'show', id: '4')
      end

      it 'routes to inspect_work' do
        expect(get: 'concern/data_sets/6/inspect_work').to route_to(controller: 'hyrax/data_sets', action: 'inspect_work', id: '6')
      end

      it 'routes to manifest' do
        expect(get: 'concern/data_sets/6/manifest').to route_to(controller: 'hyrax/data_sets', action: 'manifest', id: '6')
      end
    end
  end
end
