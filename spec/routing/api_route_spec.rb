RSpec.describe 'routing and paths', type: :routing do
  ...
  #     before do
  #       allow(Hyrax::ArkivoConstraint).to receive(:matches?) { false }
  #     end
  #
  ...
  #     before do
  #       allow(Hyrax::ArkivoConstraint).to receive(:matches?) { true }
  #     end
  #
  #     it 'routes POSTs to the items resource' do
  #       expect(post: '/api/items').to route_to(controller: 'hyrax/api/items', action: 'create', format: :json)
  #     end
  #
  #     it 'does not route GETs to the items resource' do
  #       expect(get: '/api/items').not_to route_to(controller: 'hyrax/api/items', action: 'index', format: :json)
  #     end
  #
  #     it 'does not route DELETEs to the items resource' do
  #       expect(delete: '/api/items').not_to route_to(controller: 'hyrax/api/items', action: 'destroy', format: :json)
  #     end
  #
  #     it 'does not route PUTs to the items resource' do
  #       expect(put: '/api/items').not_to route_to(controller: 'hyrax/api/items', action: 'update', format: :json)
  #     end
  #
  #     it 'does not route PATCHes to the items resource' do
  #       expect(patch: '/api/items').not_to route_to(controller: 'hyrax/api/items', action: 'update', format: :json)
  #     end
  #
  ...
  #         expect(get: subject).to route_to(controller: 'hyrax/api/items', action: 'show', id: item_id, format: :json)
  #       end
  #
  #       it 'routes PUTs to an item resource' do
  #         expect(put: subject).to route_to(controller: 'hyrax/api/items', action: 'update', id: item_id, format: :json)
  #       end
  #
  #       it 'routes DELETEs to an item resource' do
  #         expect(delete: subject).to route_to(controller: 'hyrax/api/items', action: 'destroy', id: item_id, format: :json)
  #       end
  #     end
  #   end
  # end
  ...
  #     expect(get: '/api/zotero').to route_to(controller: 'hyrax/api/zotero', action: 'initiate')
  #   end
  # end
  #
  # describe 'Zotero callbacks' do
  #   it 'routes GETs to the callback resource' do
  #     expect(get: '/api/zotero/callback').to route_to(controller: 'hyrax/api/zotero', action: 'callback')
  #   end
  # end
