...
RSpec.describe ::Deepblue::DeactivateExpiredEmbargoesService do
  ...
  describe 'constants' do
    it "resolves them" do
      expect( described_class.deactivate_expired_embargoes_service_debug_verbose ).to eq false
    end
  end

  describe 'shared' do

    RSpec.shared_examples 'DeactivateExpiredEmbargoesService' do |debug_verbose_count|
      ...
      it 'it calls the service' do
        save_debug_verbose = described_class.deactivate_expired_embargoes_service_debug_verbose
        described_class.deactivate_expired_embargoes_service_debug_verbose = dbg_verbose
  ...
  describe 'calls the service' do
    ...
    it_behaves_like 'DeactivateExpiredEmbargoesService', debug_verbose_count
  end
