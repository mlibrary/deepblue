...
RSpec.describe ::Deepblue::DoiMintingService do
  ...
  describe 'module debug verbose variables' do
    it "they have the right values" do
      ...
      expect( described_class.doi_ensure_doi_minted_debug_verbose ).to eq( false )
  ...
  let(:doi_minting_2021_service_enabled) { true }
  let(:doi_email_user_enabled)           { false }
  ...
  describe 'module variables' do
    ...
    it { expect(described_class.doi_minting_service_email_user_on_success).to eq doi_email_user_enabled }
  end
  ...
  describe 'all', skip: false do
    RSpec.shared_examples 'shared ::Deepblue::DoiMintingService' do |dbg_verbose,service_enabled,email_user|
      ...
      before do
        ...
        described_class.doi_minting_2021_service_enabled = service_enabled
        described_class.doi_minting_service_email_user_on_success = email_user
      end
      after do
        described_class.doi_minting_service_debug_verbose = debug_verbose
        described_class.doi_minting_2021_service_enabled = doi_minting_2021_service_enabled
        described_class.doi_minting_service_email_user_on_success = doi_email_user_enabled
      end
      context do
