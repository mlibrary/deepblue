...
describe ::Deepblue::AnalyticsIntegrationService do
  ...
  describe 'constants' do
    it "resolves them" do
      expect( ::Deepblue::AnalyticsIntegrationService.ahoy_tracker_debug_verbose         ).to eq( true )
      expect( ::Deepblue::AnalyticsIntegrationService.analytics_helper_debug_verbose     ).to eq( true )
      ...
      expect( ::Deepblue::AnalyticsIntegrationService.event_tracking_debug_verbose       ).to eq( true )
