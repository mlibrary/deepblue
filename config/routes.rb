...
Rails.application.routes.draw do
  ...
  post '/email_dashboard_action/' => 'email_dashboard#action'
  ...
  get '/file_sys_exports_action/', controller: 'file_sys_export/file_sys_exports', action: :action
  post '/file_sys_exports_action/', controller: 'file_sys_export/file_sys_exports', action: :action
