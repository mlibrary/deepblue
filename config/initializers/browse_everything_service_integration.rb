...
BrowseEverythingIntegrationService.setup do |config|
  ...
  begin
    ...
    config.browse_everything_controller_debug_verbose = false
    config.browse_everything_controller2_debug_verbose = false
    config.browse_everything_driver_authentication_factory_debug_verbose = false
    config.browse_everything_driver_base_debug_verbose = false
    config.browse_everything_driver_base2_debug_verbose = false
    config.browse_everything_driver_dropbox_debug_verbose = false
    config.browse_everything_driver_dropbox2_debug_verbose = false
    config.browse_everything_views_debug_verbose = false
  rescue Exception => e
