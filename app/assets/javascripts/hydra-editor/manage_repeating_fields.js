...
(function($){
    var DEFAULTS = {
        ...
        addHtml:           '<button type=\"button\" class=\"btn btn-link add addAnother\"><span class=\"glyphicon glyphicon-plus\"></span><span class="controls-add-text"></span></button>',
        addText:           'Add another',

        removeHtml:        '<button type=\"button\" class=\"btn btn-link remove removeAnother\"><span class=\"glyphicon glyphicon-remove\"></span><span class="controls-remove-text"></span> <span class=\"sr-only\"> previous <span class="controls-field-name-text">field</span></span></button>',
        removeText:         'Remove',
    ...
    $.fn.manage_fields = function(option) {
        ...
        return this.each(function() {
            console.log( "manage_repeating_fields manage fn")
            console.trace( "manage_repeating_fields manage fn:" )
            var $this = $(this);
