...
module Hyrax
  ...
  class AnonymousLinksViewerController < DownloadsController
    ...
    rescue_from AnonymousError, with: :render_single_use_error
    ...
    def not_found_exception
      AnonymousError.new( t('hyrax.single_use_links.error.not_found') )
    end

    def asset
      @asset ||= if single_use_link.is_a? AnonymousLink
    ...
    def current_ability
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ...
                                             "single_use_link=#{single_use_link}",
                                             "" ] if single_use_links_viewer_controller_debug_verbose
      @current_ability ||= AnonymousLinksViewerController::Ability.new current_user, single_use_link
    end
    ...
    class Ability
      ...
      def initialize(user, single_use_link)
        ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                               ...
                                               "user=#{user}",
                                               "single_use_link=#{single_use_link}",
                                               "" ] if AnonymousLinksViewerController.single_use_links_viewer_controller_debug_verbose
        @user = user || ::User.new
