...
module Hyrax
  # Generated controller for UmrdrWork
  class UmrdrWorksController < ApplicationController
    # Adds Hyrax behaviors to the controller.
    include Umrdr::WorksControllerBehavior
    include Hyrax::BreadcrumbsForWorks
    self.curation_concern_type = ::UmrdrWork

    # Use this line if you want to use a custom presenter
    self.show_presenter = Hyrax::UmrdrWorkPresenter
