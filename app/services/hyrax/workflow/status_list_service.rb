...
module Hyrax
  module Workflow
    ##
    # monkey # (at)deprecated use the Hyrax::Workflow::ActionableObjects enumerator instead.
    ...
    class StatusListService
      ...
      def search_solr
        ...
        WorkRelation.new.search_with_conditions(q, method: Hyrax.config.solr_default_method)
      end
