...
module Hyrax
  ...
  class MultipleMembershipChecker
    ...
    # monkey # (at)deprecated Use #check instead; for removal in 4.0.0
    def validate
    ...
    # monkey begin
    # modified in hyrax v2 to increase the number of a members before failing
    def check_v3_0_2(collection_ids:, include_current_members: false)
