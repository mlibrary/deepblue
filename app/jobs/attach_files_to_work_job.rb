...
class AttachFilesToWorkJob < ::Hyrax::ApplicationJob
  ...
  private
    ...
    def file_item_msg( t_key:, file_name:, file_size: )
      file_name = ::Deepblue::EmailHelper.escape_html( file_name )
      rv = ::Deepblue::EmailHelper.t!( t_key, file_name: file_name, file_size: file_size )
      return rv
    end
    ...
    def notify_attach_files_to_work_job_complete( successful_uploads:, failed_uploads: )
      ...
      ::Deepblue::TicketHelper.ticket_add_comment_with_status_update( curation_concern: work,
                                                                      comment: lines.join( "\n" ),
                                                                      test_mode: false,
