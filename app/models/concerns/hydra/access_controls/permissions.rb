  ...
  module AccessControls
    module Permissions
      ...
      def discover_groups
        ...
        rv = search_by_type_and_mode(:group, Hydra::ACL.Discover).map(&:agent_name)
        ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                               ::Deepblue::LoggingHelper.called_from,
                                               "rv=#{rv}",
                                               "" ] if hydra_access_controls_permissions_debug_verbose
      ...
      def read_groups
        ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                               ::Deepblue::LoggingHelper.called_from,
                                               "" ] if hydra_access_controls_permissions_debug_verbose
        rv = search_by_type_and_mode(:group, ::ACL.Read).map(&:agent_name)
        ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                               ::Deepblue::LoggingHelper.called_from,
                                               "rv=#{rv}",
                                               "" ] if hydra_access_controls_permissions_debug_verbose
      ...
      def edit_groups
        ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                               ::Deepblue::LoggingHelper.called_from,
                                               "" ] if hydra_access_controls_permissions_debug_verbose
        rv = search_by_type_and_mode(:group, ::ACL.Write).map(&:agent_name)
        ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                               ::Deepblue::LoggingHelper.called_from,
                                               "rv=#{rv}",
                                               "" ] if hydra_access_controls_permissions_debug_verbose
      ...
      def search_by_mode(mode)
        ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                               ...
                                               "mode=#{mode}",
                                               "" ] if hydra_access_controls_permissions_debug_verbose
        rv = permissions.to_a.select do |p|
