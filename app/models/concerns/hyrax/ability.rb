...
# monkey override, only to get rid of: DEPRECATION WARNING: Dangerous query method (method whose arguments are used as raw SQL) called with non-attribute argument(s): "DISTINCT source_id".
    ...
    private
      ...
      def admin_set_with_deposit?
        ids = PermissionTemplateAccess.for_user(ability: self,
                                      ...
                                      .select(:source_id) # monkey
                                      .distinct # monkey
                                      .pluck(:source_id) # monkey
