...
module Deepblue
  ...
  module TeamdynamixHelper
    ...
    mattr_accessor :teamdynamix_helper_debug_verbose, default: false
    mattr_accessor :tdx_helper_debug_verbose, default: false
    ...
    mattr_accessor :tdx_allow_add_comment
    mattr_accessor :tdx_allow_create_users
    mattr_accessor :tdx_app_name,                     default: 'TeamDynamix'
    mattr_accessor :tdx_field_values_discipline_map
    mattr_accessor :tdx_integration_hostnames
    mattr_accessor :tdx_integration_hostnames_prod
    mattr_accessor :tdx_integration_enabled
    mattr_accessor :tdx_manager_project_key
    mattr_accessor :tdx_manager_issue_type
    mattr_accessor :tdx_rest_url
    mattr_accessor :tdx_rest_api_url
    mattr_accessor :tdx_rest_create_users_url
    mattr_accessor :tdx_test_mode
    mattr_accessor :tdx_url
    mattr_accessor :tdx_use_authoremail_as_requester, default: false

    def self.tdx_add_comment( curation_concern:, event:, comment: )
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
                                              "tdx_enabled=#{tdx_enabled}",
                                              "tdx_allow_add_comment=#{tdx_allow_add_comment}",
                                              "" ] ) if tdx_helper_debug_verbose
      return unless tdx_enabled
      return unless tdx_allow_add_comment
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
      ...
      curation_concern.curation_notes_admin.each do |note|
        ...
        if note =~ /^\s*Jira ticket: https?:[^\s]+(DBHELP\-\d+).*$/
          ...
          return tdx_service_desk_request_comment( issue_key: issue_key, comment: comment )
        end
      end
      return false
    end

    def self.tdx_build_summary_for( curation_concern: )
    ...
    def self.tdx_client( client: nil, tdx_is_enabled: tdx_enabled, is_verbose: false )
      return client if client.present?
      return client unless tdx_is_enabled
      return client if tdx_test_mode && !tdx_is_enabled
      # TODO: catch errors
      client = JIRA::Client.new( tdx_client_options )
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
                                              "client.to_json=#{client.to_json}",
                                              "" ],
                                            bold_puts: is_verbose ) if is_verbose || tdx_helper_debug_verbose
      return client
    end
    ...
    def self.tdx_create_user( email:, client: nil, is_verbose: false, delay_after_create: 10 )
      return false unless tdx_enabled
      return false unless tdx_allow_create_users
      return false if email.blank?
      client = tdx_client( client: client )
      if email =~ /^([^@]+)@.+$/
        username = Regexp.last_match(1)
      end
      return false if username.blank?
      user_options = { "username" => username, "emailAddress" => email, "displayName" => email }
      path = tdx_rest_create_users_url
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
      ...
      tdx_debug_verbose_for_client_response( client: client, response: post_rv, is_verbose: is_verbose )
      rv = "200" == post_rv.code
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
                                              "post_rv=#{post_rv}",
    ...
    def self.tdx_debug_verbose_for_client_response( client:, response:, is_verbose: )
      return if !( is_verbose || tdx_helper_debug_verbose )
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ::Deepblue::LoggingHelper.called_from,
                                             "client&.to_json=#{client&.to_json}",
    ...
    def self.tdx_enabled
      JiraHelper.tdx_integration_enabled
    end

    def self.tdx_new_ticket( client: nil,
                             deposit_id:,
                             deposit_url:,
                             description:,
                             discipline:,
      ...
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ::Deepblue::LoggingHelper.called_from,
                                             "return if client.blank? #{client.blank?} && !tdx_enabled=#{!tdx_enabled}",
      ...
      if client.blank? && !tdx_enabled
        msg_queue << "tdx client is blank and #{tdx_app_name} is not enabled" unless msg_queue.nil?
        return nil
      end
      ...
      issue = tdx_service_desk_request_new_ticket( client: client, summary: summary, is_verbose: is_verbose )
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ::Deepblue::LoggingHelper.called_from,
                                             "summary=#{summary}",
                                             "description=#{description}",
      ...
      tdx_new_ticket_add_fields( client: client,
                                 issue: issue,
                                 deposit_id: deposit_id,
                                 deposit_url: deposit_url,
                                 description: description,
    ...
    def self.tdx_new_ticket_add_fields( client:,
                                        issue:,
                                        deposit_id:,
                                        deposit_url:,
                                        description:,
      ...
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ...
                                             "" ],
                                           bold_puts: is_verbose if is_verbose || tdx_helper_debug_verbose
      return nil if client.blank? && !tdx_enabled
      ...
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ...
                                              "" ],
                                            bold_puts: is_verbose ) unless rv
      sopts = { "fields" => { FIELD_NAME_DISCIPLINE => tdx_field_values_discipline_map[discipline] } }
      rv = issue.save( sopts )
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
                                              "issue.save( #{sopts} ) rv=#{rv}",
    ...
    def self.tdx_requester( client: nil, user: nil, is_verbose: false, delay_after_create_user: 0 )
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
                                              "tdx_requester( user: #{user} )",
                                              "delay_after_create_user=#{delay_after_create_user}",
                                              "" ] ) if tdx_helper_debug_verbose
      return { name: user } unless tdx_enabled
      return { name: user } if tdx_test_mode
      return {} if user.nil?
      client = tdx_client( client: client )
      hash = tdx_user_as_hash( user: user, client: client, is_verbose: is_verbose )
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
                                              "hash=#{hash}",
                                              "" ] ) if tdx_helper_debug_verbose
      return hash if hash.present?
      if tdx_create_user( client: client,
                          email: user,
                          is_verbose: is_verbose,
                          delay_after_create: delay_after_create_user )
        ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                                ::Deepblue::LoggingHelper.called_from,
                                                "try tdx_user_as_hash after successful create user",
                                                "" ] ) if tdx_helper_debug_verbose
        hash = tdx_user_as_hash( user: user, client: client, is_verbose: is_verbose )
        ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                                ::Deepblue::LoggingHelper.called_from,
    ...
    def self.tdx_service_desk_request_comment( client: nil,
                                               issue_key:,
                                               comment:,
                                               public_comment: true,
                                               is_verbose: false )
      ...
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ...
                                             "" ],
                                           bold_puts: is_verbose if is_verbose || tdx_helper_debug_verbose
      uri = "#{JiraHelper.tdx_rest_url}servicedeskapi/request/#{issue_key}/comment"
      uri_parsed = URI.parse( uri )
      request = Net::HTTP::Post.new( uri_parsed )
      request.basic_auth( Settings.tdx.username, Settings.tdx.password )
      ...
      tdx_debug_verbose_for_client_response( client: client, response: response, is_verbose: is_verbose )
      return false
    end

    def self.tdx_service_desk_request_new_ticket( client: nil, summary:, is_verbose: false )
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ::Deepblue::LoggingHelper.called_from,
                                             "return if client.blank? #{client.blank?} && !tdx_enabled=#{!tdx_enabled}",
                                             "client&.to_json=#{client&.to_json}",
      ...
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             "data=#{data}",
                                             "" ], bold_puts: is_verbose if is_verbose || tdx_helper_debug_verbose
      uri = "#{JiraHelper.tdx_rest_url}servicedeskapi/request"
      uri_parsed = URI.parse( uri )
      request = Net::HTTP::Post.new( uri_parsed )
      request.basic_auth( Settings.tdx.username, Settings.tdx.password )
      request.content_type = "application/json"
      ...
      if '400' == response.code && 'application/json' == response.content_type
        ...
        if json["errorMessage"].starts_with?( "Sorry, but the following usernames could not be added as participant to this request:" )
          ...
          return tdx_service_desk_request_new_ticket( client: client, summary: summary, is_verbose: is_verbose )
        end
      end
    ...
    def self.tdx_ticket_curation_notes_admin_contains( curation_concern:, search_value: )
    ...
    def self.tdx_ticket_for_create( client: nil,
                                    curation_concern:,
                                    check_admin_notes_for_existing_tdx_ticket: true,
                                    is_verbose: false,
                                    msg_queue: nil )
      ...
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ::Deepblue::LoggingHelper.called_from,
                                             "curation_concern.id=#{curation_concern.id}",
                                             "check_admin_notes_for_existing_tdx_ticket=#{check_admin_notes_for_existing_tdx_ticket}",
                                             "is_verbose=#{is_verbose}",
                                             "msg_queue=#{msg_queue}",
                                             "" ] if tdx_helper_debug_verbose

      curation_admin_note_tdx_ticket_prefix = "Jira ticket: "
      if check_admin_notes_for_existing_tdx_ticket
        if tdx_ticket_curation_notes_admin_contains( curation_concern: curation_concern,
                                                      search_value: curation_admin_note_tdx_ticket_prefix )
          msg_queue << "curation concern admin notes already contains #{tdx_app_name} ticket" unless msg_queue.nil?
          return
        end
      end
      ...
      client = tdx_client( client: client )
      if tdx_use_authoremail_as_requester
        user = curation_concern.authoremail
      else
        user = curation_concern.depositor
      end
      # TODO: make delay_after_create_user a config parameter
      requester = tdx_requester( user: user, client: client, is_verbose: is_verbose, delay_after_create_user: 60 )
      requester_email = curation_concern.depositor
      summary = tdx_build_summary_for( curation_concern: curation_concern )
      ...
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ...
                                             "description=#{description}",
                                             "" ] if tdx_helper_debug_verbose
      tdx_url = JiraHelper.tdx_new_ticket( client: client,
                                             deposit_id: deposit_id,
                                             deposit_url: deposit_url,
                                             description: description,
                                             discipline: discipline,
      ...
      if tdx_url.nil?
        msg_queue << "tdx_url is nil - failed to create #{tdx_app_name} ticket" unless msg_queue.nil?
        return
      end
      unless curation_concern.respond_to? :add_curation_note_admin
        ...
        curation_concern.add_curation_note_admin( note: "#{curation_admin_note_tdx_ticket_prefix}#{tdx_url}" )
      end
    end

    def self.tdx_user_as_hash( user:, client: nil, is_verbose: false )
      return {} unless tdx_enabled
      client = tdx_client( client: client )
      ...
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ::Deepblue::LoggingHelper.called_from,
                                              "tdx_user_as_hash( user: #{user} )",
                                              "path=#{path}",
                                              "get_rv=#{get_rv}",
                                              "body=#{body}",
                                              "" ] ) if is_verbose || tdx_helper_debug_verbose
      rv = if body.blank?
             {}
           else
             arr = JSON.parse body
    ...
    def self.tdx_user_exists?( user:, client: nil, is_verbose: false )
      return true unless tdx_enabled
      hash = tdx_user_as_hash( user: user, client: client, is_verbose: is_verbose )
