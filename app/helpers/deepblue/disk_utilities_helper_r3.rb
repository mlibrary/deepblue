...
# temporary disk utilities helper for Ruby v3
# replace use of DiskUtilitiesHelper to be pushed to Ruby v2 deployment to production
# TODO: delete this when upgrade to Hyrax v3 is complete and deployed to production

module Deepblue

  module DiskUtilitiesHelperR3

    mattr_accessor :disk_utilities_helper_r3_debug_verbose, default: false
    ...
    def self.delete_dir( dir_path:, msg_handler:, recursive: false, test_mode: false )
      debug_verbose = msg_handler.debug_verbose || disk_utilities_helper_r3_debug_verbose
