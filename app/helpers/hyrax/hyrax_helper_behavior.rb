...
module Hyrax
  module HyraxHelperBehavior
    ...
    def link_to_profile(args)
      ...
      # begin monkey
      # rv = link_to text, Hyrax::Engine.routes.url_helpers.user_path(*user_path_params)
      rv = link_to text, ::Deepblue::RouteHelper.relative_url( Hyrax::Engine.routes.url_helpers.user_path(*user_path_params) )
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ::Deepblue::LoggingHelper.called_from,
                                             # "link_to text, Hyrax::Engine.routes.url_helpers.user_path(*user_path_params)=#{rv}",
                                             "link_to text, hyrax.user_path(*user_path_params)=#{rv}",
                                             "" ] if false
      return rv
      # end monkey
    end
