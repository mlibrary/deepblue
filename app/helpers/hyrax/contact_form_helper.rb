...
module Hyrax
  ...
  module ContactFormHelper
    ...
    def self.log_entries( begin_date: nil, end_date: nil )
      ...
      rv = ::Deepblue::JsonLoggerHelper.log_entries( file_path: ContactFormLogger.log_file,
                                                     begin_date: begin_date,
                                                     end_date: end_date )
      ::Deepblue::LoggingHelper.bold_debug [ ::Deepblue::LoggingHelper.here,
                                             ::Deepblue::LoggingHelper.called_from,
    ...
    #     raw_key_values = ::Deepblue::JsonLoggerHelper.parse_log_line( entry, line_number: line_number, raw_key_values: true )
