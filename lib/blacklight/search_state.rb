...
module Blacklight
  ...
  class SearchState
    ...
    # monkey # deprecation_deprecate add_facet_params: 'Use filter(field).add(item) instead'
    ...
    # monkey # deprecation_deprecate remove_facet_params: 'Use filter(field).remove(item) instead'
    ...
    # monkey # deprecation_deprecate has_facet?: 'Use filter(field).include?(value) or .any? instead'
