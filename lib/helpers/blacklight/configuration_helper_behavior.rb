...
module Blacklight::ConfigurationHelperBehavior
  ...
  def default_search_field?(selected_search_field)
    puts "default_search_field? #{selected_search_field}"
  ...
  def default_search_field2?(selected_search_field)
    puts "default_search_field2? #{selected_search_field}"
    return true if selected_search_field.blank?
    return false unless default_search_field2.present?
    puts "default_search_field2[:key]=#{default_search_field2[:key]}"
    selected_search_field == default_search_field2[:key]
  end
