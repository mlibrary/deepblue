...
module DataDen
  ...
  class AbstractExportTask < ::DataDen::AbstractTask
    ...
    # attr_accessor :debug_assume_export_succeeds
    ...
    def initialize( msg_handler: nil, options: {} )
      ...
      # @debug_assume_export_succeeds = option_value( key: 'debug_assume_export_succeeds', default_value: false )
    ...
    def run_export( noid:, size: nil )
      ...
      exporter = exporter_for( noid: noid )
      ...
      exporter.export_dir = @export_dir if @export_dir.present?
      exporter.working_dir = @working_dir if @working_dir.present?
    ...
    def exporter_for( noid: )
      # exporter = ::DataDen::DataDenExportWork.new( msg_handler:                  msg_handler,
      #                                              debug_verbose:                debug_verbose,
      ...
      #                                              debug_assume_export_succeeds: debug_assume_export_succeeds,
