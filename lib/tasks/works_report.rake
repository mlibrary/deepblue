...
namespace :deepblue do
  ...
  # bundle exec rake deepblue:works_report['{"verbose":true\,"report_dir":"/deepbluedata-prep/reports"\,"expanded_file_set_report":true}']
  # bundle exec rake deepblue:works_report['{"verbose":true\,"report_dir":"/deepbluedata-prep/reports"\,"report_file_prefix":"%timestamp%.%hostname%.works_report_exp"\,"expanded_file_set_report":true}']
