...
namespace :deepblue do
  ...
  # bundle exec rake deepblue:globus_status_report['{"quiet":false\,"report_dir":"/deepbluedata-dataden/download-prep/reports"}']
  # bundle exec rake deepblue:globus_status_report['{"quiet":false\,"report_dir":"/deepbluedata-dataden/download-prep/reports"\,"report_file_prefix":"%date%.%time%.%hostname%.globus_status_report"}']
  # bundle exec rake deepblue:globus_status_report['{"quiet":false\,"report_dir":"/deepbluedata-dataden/download-prep/reports"\,"report_file_prefix":"%timestamp%.%hostname%.globus_status_report"}']
