...
namespace :deepblue do
  ...
  # bundle exec rake deepblue:doi_pending_report['{"quiet":false\,"report_dir":"/deepbluedata-dataden/download-prep/reports"}']
  # bundle exec rake deepblue:doi_pending_report['{"quiet":false\,"report_dir":"/deepbluedata-dataden/download-prep/reports"\,"report_file_prefix":"%date%.%time%.%hostname%.doi_pending_report"}']
  # bundle exec rake deepblue:doi_pending_report['{"quiet":false\,"report_dir":"/deepbluedata-dataden/download-prep/reports"\,"report_file_prefix":"%timestamp%.%hostname%.doi_pending_report"}']
