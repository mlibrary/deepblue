...
namespace :aptrust do
  ...
  # bundle exec rake aptrust:report_all['{"add_aptrust_status":true}']
  # bundle exec rake aptrust:report_all['{"report_dir":"/deepbluedata-prep/reports/"\,"report_file":"%date%.%hostname%.aptrust_all_work_statuses.csv"}']
  ...
  # bundle exec rake aptrust:report_all['{"verbose":true}']
  # bundle exec rake aptrust:report_all['{"debug_verbose":true}']
