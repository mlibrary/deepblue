...
module Hydra
  module Ability
    ...
    def test_edit(id)
      ...
      Rails.logger.debug("[CANCAN] decision: #{result}") if hydra_ability_debug_verbose
      result
    end
    ...
    def edit_groups(id)
      ...
      Rails.logger.debug("[CANCAN] edit_groups: #{eg.inspect}") if hydra_ability_debug_verbose
      return eg
    end
    ...
    def edit_users(id)
      ...
      Rails.logger.debug("[CANCAN] edit_users: #{ep.inspect}") if hydra_ability_debug_verbose
      return ep
    end
