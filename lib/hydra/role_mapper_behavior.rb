...
module Hydra::RoleMapperBehavior
  ...
  module ClassMethods
    ...
    mattr_accessor :hydra_role_mapper_behavior_debug_verbose, default: false
    ...
    def fetch_groups(user:)
      ::Deepblue::LoggingHelper.bold_debug( [ ::Deepblue::LoggingHelper.here,
                                              ...
                                              "user=#{user}",
                                              "" ] ) if hydra_role_mapper_behavior_debug_verbose
      # "" ] + caller_locations(0,40) ) if hydra_role_mapper_behavior_debug_verbose
